...
import UIKit
//代理
protocol CSMenuViewCellDelegate : class {
    func menuViewCell(_ menuViewCell : CSMenuViewCell, selectedIndex index : Int)
}
private let kItemCell = "kItemCell"

class CSMenuViewCell: UICollectionViewCell {
    //MARK: -- 数组
    weak var delegate : CSMenuViewCellDelegate?
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        //注册
        collectionView.register(UINib.init(nibName: "CSMenuViewSubCell", bundle: nil), forCellWithReuseIdentifier: kItemCell)
    }
...
extension CSMenuViewCell : UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kItemCell, for: indexPath) as! CSMenuViewSubCell
